# Free Legal Aid Sources - Tu Abogado RD
...
- Uso permitido: mencionar como defensa legal gratuita principalmente en procesos penales para personas sin recursos o sin abogado.
- Limitación: no afirmar cobertura para todas las materias legales si no está confirmado.
...
- Limitación: no afirmar representación judicial completa en todos los casos si no está confirmado.

---

## CONAPE

- Institución: Consejo Nacional de la Persona Envejeciente.
- Público orientativo: adultos mayores de 60 años.
...
- Uso permitido: mencionar como institución de orientación o asistencia para adultos mayores, con lenguaje prudente.
- Limitación: no afirmar defensa judicial gratuita específica si no está verificada.
...
- Servicio registrado por el usuario: Servicio Legal Popular.
...
- Uso permitido: mencionar como posible asistencia legal gratuita sujeta a disponibilidad y verificación.
- Limitación: no afirmar horarios, requisitos, cobertura nacional o representación judicial completa si no está verificado.

---

# Reglas de estilo

El bot debe usar lenguaje breve y útil.

No debe convertir esta sección en una explicación larga.

No debe mostrar archivos internos ni decir “según legal_free_legal_aid_sources.md”.
